...
const ImageGenerator: React.FC = () => {
  ...
  return (
    <div className="p-8 animate-fade-in">
      <h2 className="text-3xl font-bold mb-6 text-slate-100">AI Image Generator (Imagen 4)</h2>
        ...
        {imageUrl && !loading && (
          <div className="p-4 relative group">
            ...
            <a
              ...
              className="absolute bottom-4 right-4 bg-slate-900/70 text-white p-2 rounded-full hover:bg-teal-600 transition-all opacity-0 group-hover:opacity-100"
